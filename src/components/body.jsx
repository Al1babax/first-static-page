function Body() {
    return (
        <div className="body container w-[550px] h-[459px] bg-bodycolor text-white mx-auto z-10">
            <div className="title font-bold text-[39.06px] pt-[57px] pb-6 pl-[27px]">
                <h3>Fun facts about React</h3>
            </div>
            <div className="infoList pl-[74px] pr-[86px] flex">
                <ul className="list-disc list-outside marker:text-3xl marker:text-navbarmaintext text-[16px] z-20">
                ...
                <div className="relative left-[85px] z-10">
                    <svg className="" width="132" height="235" viewBox="0 0 132 235" fill="none" xmlns="http://www.w3.org/2000/svg">
